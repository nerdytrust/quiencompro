		...
		<ul style="height: 5em;">
			...
			<li class="logo">
				...
				<li class="divider"></li>
					...
					<li class="socialitem"><a target="_blank" href="https://www.youtube.com/channel/UC_FmS17xXWbRiERUJLa4PeQ"><img src="images/icons/youtube-256.png" width="45" alt="YouTube"></a></li>
