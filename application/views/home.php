                    ...
                    <ul class="lista-1">
                        ...
                        <li style="width:100%;">
                                <div class="unit-100 hiddenmobile" >
                                    ...
                                    <img  width="100%" src="<?=base_url()?>images/dal2014winners.png" alt="Ganadores DAL2014">
                                </div>
                        </li>
                        ...
                        <li>
                            <div>
                                <a href="<?=base_url()?>facturas/detallefactura/<?=$value['id']?>" style="color:#000;">
                                    ...
                                    <div class="unit-40">
                                        <span style="font-weight:bold;"><?=$value['name']?>:
                                        </span>
                                        <span style="font-size:0.8em;"><?=$value['detail']?>
                                        </span>
                                    </div>
                                    <div class="unit-40">
                                        <div>
                                        ...
                                        <div>
                                            <span style="color:#A526A3;"><?=money_format('%i',$value['amount'])?>
                                            </span>
                                        </div>
                                    </div>
                                </a>
